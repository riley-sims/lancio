...
export const storage = {
  ...
  /** Pick image from device (file/content URI), upload to avatars bucket, return storage path. */
  uploadAvatarFromUri: async (userId: string, uri: string): Promise<{ path?: string; error: any }> => {
    try {
